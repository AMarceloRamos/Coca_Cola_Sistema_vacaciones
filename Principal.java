...
public class Principal extends JFrame implements ActionListener {
    ...
    public Principal() {
        ...
        miCalculo.setFont(new Font("Andala Mono", 1, 14));
        ...
        etiquetaBienvenido = new JLabel("Bienvenido " + nombreAdministrador);
        ...
        etiquetaTitulo = new JLabel("Datos del trabajador para el calculo de vacaciones");
        etiquetaTitulo.setBounds(45, 140, 900, 25);
        etiquetaTitulo.setFont(new Font("Andale Mono", 0, 24));
        ...
        etiquetaAPaterno.setFont(new Font("Andale Mono", 1, 12));
        ...
        etiquetaAMaterno.setFont(new Font("Andale Mono", 1, 12));
        ...
        txtAMaternoTrabajador.setBackground(new java.awt.Color(224, 224, 244));
        ...
        etiquetaDepartamento.setBounds(220, 213, 220, 25);
        ...
        etiquetaAntiguedad = new JLabel("Seleccion la Antiguedad");
        ...
        comboAntiguedad.setBounds(220, 275, 220, 25);
        ...
        comboAntiguedad.addItem("7 años o m'as de servicio");

        etiquetaResultado = new JLabel("Resultado de Cálculo");
        ...
        etiquetafooter = new JLabel("©2017 The Coca-Cola Company | Todos los Derechos reservados");
        etiquetafooter.setBounds(135, 445, 550, 30);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == miElCreador) {
            ...
            JOptionPane.showMessageDialog(null, "Desarrollado por Adrián Ramos");
        }
    }
