...
public class Licencia extends JFrame implements ActionListener, ChangeListener {
    ...
    public Licencia() {
        ...
        textarea1.setFont(new Font("Andala Mono", 0, 9));
        textarea1.setText("\n\n          TÉRMINOS Y CONDICIONES" +
                "\n\n          A. PROHIBIDA SU VENTA O DISTRIBUCION SIN AUTORIZACIÓN DE LA GEEPEDIA DE ERNESTO." +
                "\n          B. PROHIBIDA SU ALTERACION DEL CODIGO FUENTE Y DISEÑO DE LAS INTERFACES GRAFICAS. " +
        ...
        check1.setBounds(120, 290, 100, 30);
